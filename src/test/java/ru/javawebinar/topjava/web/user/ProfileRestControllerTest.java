...
import static ru.javawebinar.topjava.web.ExceptionInfoHandler.EXCEPTION_DUPLICATEEMAIL;
...
class ProfileRestControllerTest extends AbstractControllerTest {
    ...
    void registerInvalid() throws Exception {
        UserTo createdTo = new UserTo(null, null, null, null, 0);
    ...
    void registerDuplicated() throws Exception {
        UserTo createdTo = new UserTo(null, "null", "admin@gmail.com", "nulll", 243);
        mockMvc.perform(MockMvcRequestBuilders.post(REST_URL + "/register")
                .contentType(MediaType.APPLICATION_JSON)
                .content(JsonUtil.writeValue(createdTo)))
                .andDo(print())
                ...
                .andExpect(expectDuplicate(EXCEPTION_DUPLICATEEMAIL));
    }

    @Test
    @Transactional(propagation = Propagation.NEVER)
    void updateDuplicated() throws Exception {
        UserTo updatedTo = new UserTo(null, "null", "admin@gmail.com", "nulll", 234);
        mockMvc.perform(MockMvcRequestBuilders.put(REST_URL).contentType(MediaType.APPLICATION_JSON)
                .with(userHttpBasic(USER))
                .content(JsonUtil.writeValue(updatedTo)))
                .andDo(print())
